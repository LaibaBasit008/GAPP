...
$db = mysqli_connect('localhost', 'root', 'root', 'gapp','3306');
  $sq2=mysqli_query($db, "SELECT teamLead, people FROM team where Team_id='$id'");
    $rows2=array();
  ...
  echo "<tr>
          <td > ".$id."</td> 
          <td > ".$data1['teamLead']."</td>
         <td ><a class='btn' href=' user.php?User_id=".$data1['people']."'>".$data1['people']."</a></td>
          
            <td><a href='tedit.php?team_id=".$id."'>Edit</a></td>
   </tr>";
        $sn++;}}
        else{
           echo "<tr>
